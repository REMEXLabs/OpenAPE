...
public class GroupManagementHelper {
	...
	/**
	 * Creates a list with group members from HTML text area, which is used to define group member ships.
	 * 
	 ...
	 *            map which contains all user names as key and all user IDs as corresponding values. It must not be null!
	 * @return list with group members. If the text area respectively the parameter groupMembersAsString is empty, an
	 *         empty list will be returned.
	 */
	public static List<GroupMember> createGroupMembersFromTextArea(String groupMembersAsString, Locale locale, Map<String, String> userNameToUserIdMap){
	 ...
	 * @param members the group members. It must not be null!
	 * @param userIDToUserNameMap map which contains all user IDs as key and all user names as corresponding values. It must not be null!
	 * @return String representing the group memberships for the HTML text area
	 */
	public static String groupMembersToStringValue(List<GroupMember> members, Map<String, String> userIDToUserNameMap){
		String groupMembersAsString = "";
		for(GroupMember groupMember : members){
			String userName = userIDToUserNameMap.get(groupMember.getUserId());
			if(userName != null){
