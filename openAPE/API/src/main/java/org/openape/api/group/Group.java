 ...
 * the resources. For each resource it is defined which group is allowed to read, update and delete it and change the access rights for it. Thus which access
...
public class Group extends DatabaseObject {
	...
	/**
	 * Create a new group and set's the value of {@link Group#id} to null. This constructor should be used, to instantiate groups, which are not already stored in the database.
	 * @param name the name of the group. It must not be null or empty.
	 * @param members list with the members of this the group. If the group has no member(s) it can be empty but not null.
	 */
	 ...
	 * @param id the id of the group. It must not be null or empty.
	 * @param name the name of the group. It must not be null or empty.
	 * @param members list with the members of this the group. If the group has no member(s) it can be empty but not null.
	 */
	public Group(String id, String name, List<GroupMember> members){
		this.setId(id);
		this.setName(name);
	 ...
	 * @return the group's id, which is a string. If the group is not already stored in the database, null can be returned.
	 */
	public String getId() {
		return this.id;
	}
	...
	/**
	 * Setter for the group's id. It must not be empty and should not be null. Null is only allowed, if the group is not already stored in the database.
	...
	/**
	 * Setter for the group's members. If the group has no members, it can be empty, but not null.
	...
	/**
	 * Checks, whether the user with the given id is an admin of this group or not. The userId must not be empty or null.
	 * @param userId the user's id
	 * @return true if the user is an admin of this group and false if not
	 */
	public boolean isUserGroupAdmin(String userId){
