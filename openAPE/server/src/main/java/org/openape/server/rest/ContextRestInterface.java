...
public abstract class ContextRestInterface extends SuperRestInterface {
    ...
    protected static <contextListType> void createContextListRestEndpoint(String path, UserContextRequestHandler requestHandler,  AuthService auth, Class<UserContextList> contextListType){
        Spark.get(
                path , (req, res) -> { 
                    ...
                    try {
                        ...
                        return UserContextRESTInterface.createReturnStringListRequest(req, res,
                                contextListType, requestHandler.getAllUserContexts(url));
    ...
    public static String createReturnStringListRequest(final Request req, final Response res, final Class type, final Object data) {
