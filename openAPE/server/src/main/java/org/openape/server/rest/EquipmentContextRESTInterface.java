    ...
    public EquipmentContextRESTInterface(final EquipmentContextRequestHandler requestHandler) {
        ...
        Spark.post("/api/equipment-context", (req, res) -> {
            try {
                ...
                // object.
                EquipmentContext recievedEquipmentContext = (EquipmentContext) this.extractContentFromRequest(req,
                ...
                String equipmentContextId = requestHandler.createEquipmentContext(recievedEquipmentContext);
         ...
         */
        Spark.get("/api/equipment-context/:equipment-context-id", (req, res) -> {
            String equipmentContextId = req.params(":equipment-context-id");
            try {
                // if it is successful return equipment context.
                EquipmentContext equipmentContext = requestHandler.getEquipmentContextById(equipmentContextId);
                res.status(SuperRestInterface.HTTP_STATUS_OK);
                res.type("application/json");
         ...
         */
        Spark.put("/api/equipment-context/:equipment-context-id", (req, res) -> {
            String equipmentContextId = req.params(":equipment-context-id");
            try {
                EquipmentContext recievedEquipmentContext = (EquipmentContext) this.extractContentFromRequest(req,
                        EquipmentContext.class);
                ...
                requestHandler.updateEquipmentContextById(equipmentContextId, recievedEquipmentContext);
                res.status(SuperRestInterface.HTTP_STATUS_OK);
                return "";
