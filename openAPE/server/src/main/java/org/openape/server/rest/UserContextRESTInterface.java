...
public class UserContextRESTInterface extends SuperRestInterface {
	...
	public static void setupUserContextRESTInterface(final UserContextRequestHandler requestHandler,
		...
		Spark.get(Messages.getString("UserContextRESTInterface.UserContextURLWithoutID"), (req, res) -> {
		...
		Spark.post(Messages.getString("UserContextRESTInterface.UserContextURLWithoutID"), (req, res) -> { //$NON-NLS-1$
			...
			try {
				...
				final UserContext receivedUserContext = (UserContext) SuperRestInterface.extractObjectFromRequest(req,
						UserContext.class);
