...
public class Molecule_3_UserSection {
    public String generateUsersection() {
        ...
        for (final Entry<String, String> entry : new Atom_1_NavigationLinks()
            ...
            userSection += "<div class='userSectionLinks' id='div_" + entry.getKey()
                    + "'><a href='#' id='" + entry.getKey() + "' aria-label='"+entry.getKey()+"' title='"+entry.getKey()+"'>" + entry.getValue()
                    + "</a></div>";
        }
        return userSection;
    }
    ...
    public String generateUserSectionLogginFormulars() {
        ...
        return userSectionFormulars += ""
                ...
                + "</div>" + "<button class='btn btn-sm btn-danger' id='btnSignin'>"
    ...
    public String generateUserSectionSigninFormulars() {
        ...
        return userSectionFormulars += "" + "<div class='col-xs-4' style='float:left'>"
                ...
                + "</div>" + "<div class='col-xs-3' style='float:left'>"
                ...
                + "</div>" + "<div style='loat:left'>" + "<button class='btn btn-sm btn-danger'>"
