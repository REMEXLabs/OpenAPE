...
public class Organism_1_Topsection {
	...
	public String generateTopNavigation() {
		...
		final String topNavigationLinks = new Molecule_2_topnavigation().generateTopNavigationLinks();
		final String userSection = new Molecule_3_userSection().generateUsersection();
		final String topNavigation = "<div class='topNavigation'>" + "<div class='logo'>" + logo + "</div>"
