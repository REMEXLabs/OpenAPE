...
public class Molecule_2_topnavigation {
	public String generateTopNavigationLinks() {
		...
		for (final Entry<String, String> entry : new Atom_1_navigationLinks().generateTopNavigationLinks().entrySet()) {
			topNavigation += "<div class='navigationLinks' id='div" + entry.getKey() + "'><a href='#' id='link"
