...
public class Organism_4_Modals {
    public String generateContextModal(final String contextName, final String actionNameUpperCase) {
        ...
        final String modalContruct = "" + "<div class='modal fade' id='"+actionNameLowerCase+""
                ...
                + "      Add your Context in JSON- or XML-Format <textarea id='inputAdministration"+actionNameUpperCase+""
                + idName
                ...
                + "</div><div style='float:left'> <span style='margin-right:2.5em'><b>Content-Type:</b></span> "
                + "<select class='selectpicker' id='"+actionNameLowerCase+"SelContentType'>"
                + "<option>JSON</option>"
                + "<option>XML</option>"
                + "</select>"
                + "</div></div>"
