...
public class Organism_4_Modals {
    public String generateContextModal(final String contextName, final String actionNameUpperCase) {
        ...
        final String modalContruct = "" + "<div class='modal fade' id='"+actionNameLowerCase+""
                ...
                + "      Add your Context in JSON- or XML-Format <textarea style='80% !important' id='inputAdministration"+actionNameUpperCase+""
                + idName
                ...
                + "<select style='margin-right:3em' class='selectpicker' id='"+actionNameLowerCase+""+idName+"OutputSelContentType'>"
                + "<option>JSON</option>"
                + "<option>XML</option>"
                + "</select>"
