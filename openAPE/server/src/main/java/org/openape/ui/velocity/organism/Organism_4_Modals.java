...
public class Organism_4_Modals {
    ...
    public String generateSignupModal() {
        final String modalSignup = ""
                ...
                + "</tr>"
                + "<tr>"
                + " <td><label for='inputSignupPasswordRepeat'>Repeat password: </label></td>"
                + " <td> "
                + "     <div id='formGroupSignupPasswordRepeat' class='form-group' role='form'>"
                + "          <div class='col-sm-15'>"
                + "                 <form>"
                + "               <input type='password' class='form-control' id='inputSignupPasswordRepeat' placeholder='Password'>"
                + "                <small id='signupPasswordRepeatErrMessage' class='form-text text-muted' style='color:red'></small>"
                + "               <span class='glyphicon glyphicon-remove form-control-feedback' id='signupPasswordRepeatErrIcon'></span>"
                + "             </form>"
                + "             </div>"
                + "          </div>"
                + " </td>"
