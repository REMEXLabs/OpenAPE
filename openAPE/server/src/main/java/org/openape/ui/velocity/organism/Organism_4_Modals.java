...
public class Organism_4_Modals {
    ...
    public String generateSigninModal() {
        ...
        final String modalSignin = ""
                ...
                + "        <h3 id='exampleModalLongTitle'>Sign in</h3>" + "      </div>"
                + "      <div class='modal-body' align='center' style='min-height:10em'>"
                + " <table width='100%' style='border-collapse:separate; border-spacing:1em;'>" + " <tr>"
                + "	<td>Username: </td>" + "	<td> "
                ...
                + "			    </div>" + "		 </div>" + "	</td>" + "</tr>" + "<tr>" + "	<td>Password: </td>"
                + "	<td> " + "		<div id='formGroupSigninPassword' class='form-group' role='form'>"
                + "			 <div class='col-sm-15'>"
                ...
                + "			    </div>" + "		 	 </div>" + "	</td>" + "</tr>" + "<tr>"
                + "	<td>Security Question (12+3)? </td>" + "	<td> "
    ...
    public String generateSignupModal() {
        final String modalSignup = ""
                ...
                + "  <div class='modal-dialog' role='document'>" + "    <div class='modal-content'>"
                + "      <div class='modal-header' style='background-color:#e31134; color:white;text-align:center;border-bottom: 2px solid #AB112A;'>"
                + "        <h3 id='exampleModalLongTitle'>Sign up</h3>" + "      </div>"
                + "      <div class='modal-body' align='center' style='min-height:10em'>"
                + " <table width='100%' style='border-collapse:separate; border-spacing:1em;'>" + " <tr>"
                + "	<td>Username: </td>" + "	<td> "
                ...
                + "			    </div>" + "		 </div>" + "	</td>" + "</tr>" + "<tr>" + "	<td>Email: </td>"
                + "	<td> " + "		<div id='formGroupSignupEmail' class='form-group' role='form'>"
                + "			 <div class='col-sm-15'>"
                ...
                + "			    </div>" + "		 	 </div>" + "	</td>" + "</tr>" + "<tr>" + "	<td>Password: </td>"
                + "	<td> " + "		<div id='formGroupSignupPassword' class='form-group' role='form'>"
                + "			 <div class='col-sm-15'>"
